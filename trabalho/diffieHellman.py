...
def generate_public_secret(base, private_key, shared_key):
  return (base ** private_key) % shared_key

def generate_shared_secret(received_secret, private_key, shared_key):
  return (received_secret ** private_key) % shared_key
